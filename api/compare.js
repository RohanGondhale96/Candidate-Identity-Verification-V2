...
const PROMPT = [
  ...
  '',
  'For similarity, use the FULL 0-100 range and give a precise, fine-grained score - do NOT round to',
  'multiples of 5 or 10. Let subtle differences in pose, lighting, expression, angle and image quality',
  'produce distinct non-round numbers (e.g. 93, 87, 12, 7) rather than repeated identical values.',
  '',
